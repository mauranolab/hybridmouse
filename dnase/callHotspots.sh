...
# ~/bin/hotspot/hotspot-deploy/bin/writeChromInfoBed.pl /home/maurano/bwaIndex/mm10all/mm10all.female.fa && cat chromInfo.bed | grep -v hap | grep -v random | grep -v chrUn | grep -v scaffold > /vol/mauranolab/mauram01/hybridmice/dnase/src/hotspots.mm10.female.chromInfo.bed && rm -f chromInfo.bed
_CHROM_FILE_ = /vol/mauranolab/mauram01/hybridmice/dnase/src/hotspots.mm10.female.chromInfo.bed
...
## left blank.
_OMIT_REGIONS_: "/vol/isg/annotation/bed/%(_GENOME_)s/repeat_masker/Satellite.bed /vol/mauranolab/mauram01/hybridmice/dnase/src/hotspots.omit.chrM.bed"
